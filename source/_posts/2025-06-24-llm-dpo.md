...
上一篇详细介绍了 RLHF 训练中的 [PPO 原理和实现细节](https://murphypei.github.io/blog/2025/05/llm-ppo.html)。本文聚焦于 Direct Preference Optimization（DPO）在 LLM 对齐训练中的原理与实践。文章先从直观动机与数学推导入手，给出训练流程与实现要点，随后比较 DPO 与基于奖励的 PPO 在适用场景、训练复杂度与稳定性上的异同，最后给出工程建议与常见陷阱。
